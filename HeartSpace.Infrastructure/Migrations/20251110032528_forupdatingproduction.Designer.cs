...
namespace HeartSpace.Infrastructure.Migrations
{
    ...
    [Migration("20251110032528_forupdatingproduction")]
    partial class forupdatingproduction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HeartSpace.Domain.Entities.ConsultantConsulting", b =>
                {
                    ...
                    b.ToTable("ConsultantConsultings", (string)null);
                });
            ...
            modelBuilder.Entity("HeartSpace.Domain.Entities.PaymentRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HeartSpace.Domain.Entities.PaymentRequest", b =>
                {
                    b.HasOne("HeartSpace.Domain.Entities.Appointment", "Appointment")
                        ...
                        .HasForeignKey("HeartSpace.Domain.Entities.PaymentRequest", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
