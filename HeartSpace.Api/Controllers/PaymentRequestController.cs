...
namespace HeartSpace.Api.Controllers
{
    ...
    public class PaymentRequestController : BaseController
    {
        ...
        public async Task<ActionResult<ApiResponse<List<PaymentRequestResponse>>>> GetPaymentRequestsByAppointmentId(Guid appointmentId)
        {
        ...
        public async Task<ActionResult<ApiResponse<List<PaymentRequestResponse>>>> GetPaymentRequestsByConsultantId(Guid consultantId)
        {
